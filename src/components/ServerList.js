...
export default function ServerList(props) {
    ...
    return (
        <>
            <div className='server-list w-5/2'>
                <div onClick={createServer} className='createNewServer'>
                    <div className='createCircle-btn' data-name="Create new server">
                        <FontAwesomeIcon icon={faPlus} color="white" />
                    </div>
                </div>

                <div className='serverList_flexBox'>
                      <label>Chats</label>  
                    <div className='serverList_flex'>
