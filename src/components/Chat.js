...
import { faUserPlus, faPhoneSlash } from '@fortawesome/free-solid-svg-icons'
import '../components/css/ServerList.css'
import { setBlogChannelChecked, selectBlogChannelChecked } from '../features/channelSlice';
...
export default function Chat(props) {
    ...
    const isChecked = useSelector(selectBlogChannelChecked);
    ...
    let channelType = props.channelType
    let user = props.user
    ...
    useEffect(() => {
        ...
        const requestOptions = {
            ...
            body: JSON.stringify({ channelId: currentChannel.channel.channelId,
                channelType: currentChannel.channel.channelType })
    ...
    }, [currentChannel.channel, channelType])
